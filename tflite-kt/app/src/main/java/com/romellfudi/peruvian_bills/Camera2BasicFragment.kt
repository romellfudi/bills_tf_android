...
class Camera2BasicFragment : Fragment(), FragmentCompat.OnRequestPermissionsResultCallback, CoroutineScope {
    ...
    private fun openCamera(width: Int, height: Int) {
        checkedPermissions = if (!checkedPermissions && !allPermissionsGranted()) {
            activity!!.requestPermissions(requiredPermissions, PERMISSIONS_REQUEST_CODE)
            return
        } else {
            true
        }
    ...
    private fun classifyFrame() {
        ...
        val bitmap = textureView!!.getBitmap(ImageClassifier.Companion.DIM_IMG_SIZE_X, ImageClassifier.Companion.DIM_IMG_SIZE_Y)
    ...
    private class CompareSizesByArea : Comparator<Size> {
        override fun compare(lhs: Size, rhs: Size) = java.lang.Long.signum(
